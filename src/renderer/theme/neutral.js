...
export const neutralTheme = {
  ...
  tokens: {
    ...
    "--font-family-heading": "\"Hanken Grotesk\", -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, Helvetica, Arial, sans-serif",
    "--font-family-code": "\"JetBrains Mono\", ui-monospace, \"SF Mono\", Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace",
    ...
    "--color-background-surface": "light-dark(#f8f9ff, #0b1c30)",
    "--color-background-body": "light-dark(#f8f9ff, #0b1c30)",
    "--color-background-card": "light-dark(#ffffff, #131b2e)",
    "--color-background-popover": "light-dark(#ffffff, #131b2e)",
    "--color-background-muted": "light-dark(#eff4ff, #1c283d)",
    "--color-accent": "light-dark(#0051d5, #316bf3)",
    "--color-accent-muted": "light-dark(#e5eeff, #1c283d)",
    ...
    "--color-text-primary": "light-dark(#0b1c30, #f8f9ff)",
    "--color-text-secondary": "light-dark(#45464d, #aec1df)",
    "--color-text-disabled": "light-dark(#76777d, #7185a6)",
    "--color-text-accent": "light-dark(#0051d5, #316bf3)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#0b1c30",
    "--color-on-accent": "light-dark(#ffffff, #ffffff)",
    "--color-on-success": "light-dark(#ffffff, #0b1c30)",
    "--color-on-error": "light-dark(#ffffff, #ffffff)",
    "--color-on-warning": "#0b1c30",
    "--color-icon-accent": "light-dark(#0051d5, #316bf3)",
    "--color-icon-primary": "light-dark(#0b1c30, #f8f9ff)",
    "--color-icon-secondary": "light-dark(#45464d, #aec1df)",
    "--color-icon-disabled": "light-dark(#76777d, #7185a6)",
    "--color-border": "light-dark(#c6c6cd, #2b3b55)",
    "--color-border-emphasized": "light-dark(#76777d, #455879)",
    "--color-success": "light-dark(#007004, #9fe59b)",
    "--color-error": "light-dark(#ba1a1a, #ffdad6)",
    "--color-warning": "light-dark(#745b00, #fdcf4f)",
    "--color-success-muted": "light-dark(#c5e5c0, #84c9803D)",
    "--color-error-muted": "light-dark(#ffdad6, #93000a)",
    ...
    "--color-border-gray": "light-dark(#c6c6cd, #45464d)",
    "--color-icon-gray": "light-dark(#45464d, #bec6e0)",
    "--color-text-gray": "light-dark(#0b1c30, #f8f9ff)",
    "--color-skeleton": "light-dark(#eff4ff, #131b2e)",
    "--color-shadow": "light-dark(#0f172a0d, #0000004D)",
    "--color-tint-hover": "light-dark(#0051d5, #316bf3)",
    ...
    "--radius-page": "0.75rem",
    "--radius-full": "9999px",
    "--shadow-low": "0 1px 3px light-dark(rgba(15, 23, 42, 0.04), rgba(0, 0, 0, 0.25)), inset 0 0 0 1px light-dark(#c6c6cd, rgba(255, 255, 255, 0.1))",
    "--shadow-med": "0 4px 20px light-dark(rgba(15, 23, 42, 0.05), rgba(0, 0, 0, 0.35)), inset 0 0 0 1px light-dark(#c6c6cd, rgba(255, 255, 255, 0.12))",
    "--shadow-high": "0 8px 30px light-dark(rgba(15, 23, 42, 0.08), rgba(0, 0, 0, 0.5)), inset 0 0 0 1px light-dark(#c6c6cd, rgba(255, 255, 255, 0.15))",
